...
void main()
{
    ...
    //moving y using x and z seperatly
    float elevation = sin(modelPosition.x * uBigWavesFrequency.x + uTime * uBigWaveSpeed) * 
                      ...
                      uBigWavesElevation; //goes to -0.1 to +0.1
    ...
    vec4 viewPoaition = viewMatrix * modelPosition;
    vec4 projectedPosition = projectionMatrix * viewPoaition;

    gl_Position = projectedPosition;

    //Varyings
    //send y height amount to fragment
